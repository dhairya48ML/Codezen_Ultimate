# """
# Simple in-memory store for CodeZen Ultimate.
# Later replace with Redis or DB.
# """
# from typing import Dict, Any

# INSTALLATIONS: Dict[str, Dict[str, Any]] = {}   # repo_full_name → {installation_id, token, expires_at}
# PR_STATUS: Dict[str, Dict[str, Any]] = {}       # repo_full_name → {last_pr, status, merged, docs_path}

# # def save_installation(repo_full: str, data: Dict[str, Any]):
# #     INSTALLATIONS[repo_full] = data
...
# def get_pr_status(repo_full: str):
#     return PR_STATUS.get(repo_full, {"status": "unknown"})
